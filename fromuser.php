  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarNavDarkDropdown">
        <div class="navbar-nav">
            ...
            <li class="scroll-to-section"><a href="userdata.php">from User</a></li>
        ...
        <h3>รายการคำร้อง </h3>
                    <table  id = "myTable">
                        ...
                        <tbody>
                            ...
                            $stmt = $conn->prepare("SELECT* FROM toadmin ");
                            $stmt->execute();
                    ...
                    //แสดงผลตาราง
                        ...
                        {?>
                            <tr>
                                ...
                                <td><?= $row['reason'];?></td>
                                <td><?= $row['doc_name'];?></td>
                                <td><a href="delete3.php?gid=<?php echo $row['gid'];?>" onclick=" return confirm('ลบรายการ');">delete</a></td> 
                            <?php } ?>
                        </tbody>
                    </table>
				</div> 
